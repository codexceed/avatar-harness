...
- Trigger to implement: deferred per Principle C until the first non-Python dogfood/eval target — record the journal id here when it lands. The no-crash + `python -m` floor should ship ahead of it.
