...
```python
ModelDecision(*, thought_summary: str = '', action: ToolCall | FinalAnswer | AskUser, retry_trace: list[DecisionRetryNote] = <factory>, usage: DecisionUsage | None = None, transport: str = '') -> None
```
