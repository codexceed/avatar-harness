...
- [ ] **3.2c · plan mode** — read-only plan task → `PlanModal` approve → the approved plan seeds the edit task as a constraint (rides the `investigating→editing` gate).
